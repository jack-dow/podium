...
const theme = {
  ...
  textColor: {
    ...
    label: colors.zinc[700], // zinc-700
    primary: {
      normal: colors.zinc[900], // zinc-900
      muted: colors.zinc[500], // zinc-500
    },
    positive: {
      normal: colors.emerald[800], // emerald-800
      muted: colors.emerald[700], // emerald-700
    },
    warning: {
      normal: colors.amber[800], // amber-800
      muted: colors.amber[700], // amber-700
    },
    danger: {
      normal: colors.red[800], // red-800
      muted: colors.red[700], // red-700
    },
    info: {
      normal: colors.blue[800], // blue-800
