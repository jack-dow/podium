 ...
 */
export const useBottomSheetBackHandler = (bottomSheetRef: React.ForwardedRef<GorhomBottomSheet>) => {
...
const BottomSheetRoot = forwardRef<GorhomBottomSheet, BottomSheetProps>(
  ({ style, snapPoints, children, onClose, startingIndex = -1 }, ref) => {
